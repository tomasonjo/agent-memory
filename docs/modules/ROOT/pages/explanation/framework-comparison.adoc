...
NOTE: The Microsoft Agent Framework column targets `agent-framework>=1.0.0b260212`. The framework has reached GA — check the https://github.com/microsoft/agent-framework[official releases] for the latest stable version.
...
NOTE: This integration targets Microsoft Agent Framework v1.0.0b260212. The framework has reached GA — check the https://github.com/microsoft/agent-framework[official releases] for the latest stable version.
