...
image::diagrams/1-natural-relationship-modeling.png[Neo4j graph showing Message nodes connected to Entity nodes via MENTIONS relationships,width=480,align=left]
