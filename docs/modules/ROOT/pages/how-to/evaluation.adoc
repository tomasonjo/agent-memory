...
* Not a substitute for the ``ConsolidationRun`` audit trail in v0.5
  P1.5 — the eval harness measures *current* state; audit nodes record
  *change* over time.
