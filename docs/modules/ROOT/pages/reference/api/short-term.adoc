...
Get a conversation and all its messages for a session.

[source,python]
----
conversation = await short_term.get_conversation(
    session_id: str,
    limit: int | None = None,
)
# conversation.messages contains the list of Message objects
----
